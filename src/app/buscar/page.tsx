 ...
 * @dependencies SearchBar, ListingCard, Pagination, ModelSpecsCard, listings search helpers
 */
...
export default async function SearchPage({ searchParams }: PageProps) {
  ...
  const selectedModelSeed = selectedModel
    ? IPHONE_CATALOG_MODELS.find((entry) => entry.slug === selectedModel.slug)
    : null;
  ...
  return (
    <AppShell mainClassName="gap-6">
      ...
      <div className="space-y-2">
        ...
        {selectedModel && selectedModelSpecs && selectedModelSeed ? (
          <ModelSpecsCard
