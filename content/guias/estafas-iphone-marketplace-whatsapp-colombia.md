...
En la práctica, las estafas más comunes combinan tres ingredientes:

1. Un precio que parece “demasiado bueno”.
2. Urgencia (“otro interesado”, “solo hoy”).
3. Un pago anticipado o un encuentro que nunca se concreta.
...
Pasar a WhatsApp no es ilegal ni siempre malo. El problema es cuando el vendedor **evita** dejar evidencia en Marketplace, insiste en “hablar solo por WhatsApp” y te empuja a decidir sin verificar.

Mantén capturas del anuncio original (URL, precio, fotos, perfil). Si el chat se mueve, el anuncio sigue siendo tu referencia.
...
- No puede enviarte una foto nueva del iPhone con un objeto cotidiano o un papel con la fecha.
- Siempre hay excusas para no verse: viaje, hermano, mensajero, “pásame el pasaje”.

### 5. Tracking falso, mensajero o “ya va en camino”

Algunas estafas inventan un envío con número de guía inventado, captura de mensajería o “domicilio que cobra anticipo”. Mientras no veas y pruebes el equipo, **no hay entrega**.
...
Aunque no sea la estafa “clásica” de venta de iPhone, está relacionada: si alguien te pide códigos de WhatsApp, de tu banco o de tu operador “para verificar la compra”, detente. Esos códigos pueden servir para tomar tu cuenta o facilitar un **SIM swap** / toma de cuenta. Los operadores legítimos no te piden códigos por llamada o chat improvisado para “proteger” tu WhatsApp.

---

## Checklist rápido antes de responder un anuncio

Antes de invertir tiempo (y mucho menos dinero), marca mentalmente:

- [ ] El precio está cerca del rango de mercado de modelos similares.
- [ ] El perfil no parece recién creado solo para vender.
- [ ] El vendedor acepta encuentro presencial en lugar público.
- [ ] Puede enviar fotos actuales (pantalla encendida, ajustes, batería).
- [ ] Comparte IMEI o acepta que lo consultes en persona antes de pagar.
- [ ] No pide anticipo ni “reserva”.
- [ ] No promete desbloquear iCloud / Activation Lock después.
- [ ] No te pide códigos SMS ni acceso a cuentas.

Si fallan dos o más puntos fuertes (anticipo + precio irreal + negativa a verse), es mejor seguir buscando.

---

## Proceso seguro antes de pagar (paso a paso)

Piensa en esto como un mini protocolo. Te toma poco tiempo y evita la mayoría de problemas.

### Paso 1 — Acuerda el encuentro, no el depósito

Elige un lugar público y concurrido (centro comercial, plaza transitada, cerca de vigilancia). Evita ir solo a domicilios desconocidos. Define hora y modelo exacto por escrito.

### Paso 2 — Revisa el equipo físico con calma

Con el iPhone en la mano:
...
Cuando IMEI esté limpio, no haya Activation Lock y el equipo funcione:

- Prefiere pago en el momento (efectivo o transferencia que **tú** confirmes en tu app).
- No aceptes “ya te consigné” solo con captura de pantalla.
- Evita cheques en canje o comprobantes que el banco aún no refleje como fondos disponibles.
- Si usas transferencia, verifica el abono real antes de entregar nada (esto aplica también si tú vendes).

Opcional: deja un simple comprobante de compraventa con nombres, cédula, IMEI, modelo y fecha.
...
- No permiten verificar IMEI o restablecer el equipo frente a ti.
- El precio es irreal y la explicación es vaga (“me urge”, “regalo de un primo”).
...
## Qué hacer si ya sospechas (o crees haber caído)
